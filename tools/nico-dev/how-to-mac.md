...
| `monitor-mat.py --admin-cli W [--mat-log F]…` / `run-monitor-mat.sh` | VM | one screen for a MAT run: expected machines, endpoints, machine states with milestones to go, MAT's own view; refresh 30 s |
